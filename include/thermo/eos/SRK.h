/**
 * @file SRK.h
 * @brief Soave-Redlich-Kwong EOS implementation (cubic)
 */

#ifndef THERMO_EOS_SRK_H
#define THERMO_EOS_SRK_H
...
/**
 * @brief Soave-Redlich-Kwong (SRK) EOS (mixtures supported via vdW mixing rules)
 */
class SRKEOS : public ::DMThermo::EOS {
public:
    explicit SRKEOS(const Core::Mixture& mixture);
    ...
    std::string name() const override { return "SRK"; }
    ...
    /**
     * @brief Real compressibility-factor roots at (T, P, x) from the SRK cubic in Z.
     *
    ...
    /**
     * @brief Real density roots at (T, P, x) from the SRK cubic in Z.
     *
